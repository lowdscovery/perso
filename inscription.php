...
<head>
  ...
  <title>Inscription personnel non agricole</title>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Inscrire un personnel non agricole</h2>
        </div>
        <form  method="POST" action="" enctype="multipart/form-data" class="contenu">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <input type="file" class="form-control" name="photo" id="photo" title="Selectionné la photo du personnel" required/>
