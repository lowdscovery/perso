<?php
	...
	if (isset($_POST['insertion'])) 
	{
		...
		$sql = "INSERT INTO personnel(id_categorie,nom,prenom,dateNaissance,sexe,nationalite,cin,adresse,telephone,mail,situation,nombre,diplome,grille,photo,profil,pay,jours_conge,hors_service,type_contrat,fichier_contrat,date_debut,date_fin) VALUES ('$identifiant','$nom','$prenom','$dateNaissance','$sexe','$nationalite','$cin','$adresse','$telephone','$email','$situation','$nombre','$diplome','agricole','$photo','embauche','1','0','1','$contrat','$fichier_contrat','$mois','$fin')";
